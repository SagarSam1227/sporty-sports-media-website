...
function Sidebar() {
    ...
    return (
      <>
        ...
        <div className="md:float-left md:pb-56 md:w-56 h-14 md:h-auto w-4/5 mx-auto md:mx-0 flex flex-row md:fixed md:flex-col text-center sticky md:top-0 mt-full top-3/4 drop-shadow-2xl bg-[#21252b] rounded-lg pt-4 pb-6">
          <button className="md:mb-12 hidden self-center md:flex flex-none ">
            {" "}
            <img
              className=" w-20 mt-4 "
          ...
          <Link to="/home">
            <button
              ...
              className={`md:py-4 py-0 w-40 md:w-auto self-center ml-5 flex md:mx-0 ${
            ...
            >
              <div className="flex-1 self-center">
                <img
                  className={`md:ml-16 ml-3 ${
                    isMouseOver1 || buttonClicked === "home" ? "w-9" : "w-8"
                  }`}
                  src="/assets/home-darkmode.png"
                  alt=""
                />
              </div>
              <h4
                className={`font-semibold mr-10 flex-1 md:flex hidden ml-12  ${
          ...
          {isMouseOver1 || buttonClicked === "home" ? (
            <hr className="h-0.5 bg-[#1c0000] border-0 dark:bg-gray-700"></hr>
          ) : null}
          ...
          <Link to="/news">
            <button
              ...
              className={`md:py-4 py-0 w-40 md:w-auto self-center flex md:mx-0  ${
          ...
          <button
            ...
            className={`md:py-4 py-0 w-40 md:w-auto self-center mr-7 flex md:mx-0  ${
  ...
  return (
    <>
      ...
      <div className="md:float-left md:pb-56 md:w-56 md:h-auto md:mx-0 flex md:fixed md:flex-col md:justify-normal md:top-0 w-full justify-between flex-row text-center sticky  mt-full top-3/4 drop-shadow-2xl bg-[#f5f5f5] rounded-lg pt-4">
        <button className="md:mb-12 hidden self-center md:flex flex-none">
          {" "}
          <img
            className=" w-20 mt-4 "
        ...
        <Link to="/home">
          <button
            ...
            className={`md:py-4 py-0 md:w-auto self-center ml-5 flex md:mx-0 ${
        ...
        <Link to="/news">
          <button
            ...
            className={`md:py-4 py-0 md:w-auto self-center flex md:mx-0  ${
        ...
        <button
          ...
          className={`md:py-4 py-0 md:w-auto self-center mr-7 flex md:mx-0   ${
            buttonClicked === "services" || isMouseOver4
              ? "md:bg-[#f8feff]"
              : ""
          }`}
