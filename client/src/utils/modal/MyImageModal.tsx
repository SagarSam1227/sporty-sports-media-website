...
export default function MyImageModal({ card, setIsFullImage,image }) {
...
if(seconds<=30){
  ...
  return (
    ...
    {isOptionsSelected?
    <MyImageOptionsModal card={card} setIsOptionsSelected={setIsOptionsSelected} setIsFullImage={setIsFullImage} />:null
}
    </>
  );
}
